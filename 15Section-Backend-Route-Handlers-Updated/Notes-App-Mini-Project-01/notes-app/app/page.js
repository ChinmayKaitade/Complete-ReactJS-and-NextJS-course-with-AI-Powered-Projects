...
export default function Home() {
  ...
  const onSubmit = async (e) => {
    ...
    if (!title || !content) {
      alert("All fields required. Please fill all field!");
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-gray-950 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gray-900 rounded-lg shadow-mauve-50 p-6 mb-8 border border-gray-800">
          <form onSubmit={onSubmit}>
            ...
            <div className="flex gap-2">
              <button
                disabled={isLoading}
                type="submit"
                className="flex-1 bg-yellow-500 text-gray-900 py-2 px-4 rounded-lg hover:bg-yellow-600
              disabled:bg-gray-600 transition font-semibold"
              >
                Add Note
              </button>
            </div>
